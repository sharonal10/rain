...
class GaussianModel:
    ...
    def load_ply(self, path):
        ...
        assert len(extra_f_names)==3*(self.max_sh_degree + 1) ** 2 - 3, (len(extra_f_names), self.max_sh_degree, 3*(self.max_sh_degree + 1) ** 2 - 3)
    ...
    def densify_and_prune(self, max_grad, min_opacity, extent, max_screen_size, N=2, abe_split=False):
        ...
        if not torch.all(self.get_opacity < min_opacity):
