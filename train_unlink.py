...
def training(dataset, opt, pipe, testing_iterations ,saving_iterations, checkpoint_iterations ,checkpoint, debug_from, args_dict):
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        for sub_iter in range(len(gaussians_list)):
            ...
            masked_image = image*mask # NB am applying mask to rendered for part loss
            ...
            loss = loss * args_dict['loss_coeff']
            loss.backward()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--loss_coeff', type=float, default=1.0)
